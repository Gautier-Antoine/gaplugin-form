...
function form_code() {
  ...
  echo '
    ...
    <form action="' . esc_url( $_SERVER['REQUEST_URI'] ) . '" method="post">
        ...
        <div>
          <label>
            <span class="ga-form copy">
              <input type="checkbox" name="terms" ' . ( isset($_POST['copy']) ? "checked" : null ) . '>
            </span>
            Do you want to receive a copy of your answers by email?
          </label>
        </div>
        <p>
